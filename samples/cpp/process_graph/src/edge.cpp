...
void Edge::paint(QPainter *painter, const QStyleOptionGraphicsItem *, QWidget *) {
  ...
  pathPainter.quadTo(quadSupport,
                     destPoint); // draw a quadratic bezier from source to dest
  painter->drawPath(pathPainter);

  // Similarly modify the arrow drawing section to account for the possible
  // curved line
